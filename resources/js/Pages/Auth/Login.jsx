            ...
            <form onSubmit={submit}>
                ...
                <div className="block mt-4">
                    <label className="flex items-center">
                        ...
                        <span className="ml-2 text-sm text-gray-600"><FormattedMessage id="remember_me" defaultMessage="Remember me" /></span>
                    </label>
                </div>
                ...
                <div className="flex items-center justify-end mt-4">
                    {canResetPassword && (
                        ...
                        >
                            <FormattedMessage id="forgot_your_password" defaultMessage="Forgot your password?" />
                        </Link>
                    )}
