...
export default function Authenticated({ auth, header, children , cart }) {
    const [showingNavigationDropdown, setShowingNavigationDropdown] = useState(false);

    return (
        <IntlProvider locale={auth.user.locale == 'es' ? 'es' : auth.user.locale === 'it' ? 'it' : 'en'} messages={auth.user.locale === 'es' ? Spanish : auth.user.locale === 'it' ? Italian : English}>
            ...
            <nav className="sticky top-0 w-full bg-white">
                            ...
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('database.update')} method="post">
                                            <FormattedMessage id="Update Database" defaultMessage="Update Database" />
                                        </Dropdown.Link>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        {/* Profile dropdown */}
                        <div className="px-4">
                            <div className="font-medium text-base text-gray-800">{auth.user.email}</div>
                        </div>
                ...
                <div className="w-full">
                    <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
                      ...
                      <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-6">
                        <div>
                          <Footer.Title title={<FormattedMessage id="About" defaultMessage="About" />} />
                        ...
                        <div>
                          <Footer.Title title={<FormattedMessage id="Support" defaultMessage="Support" />} />
                          <Footer.LinkGroup col={true}>
                            <Footer.Link href="#">
                              ''
                            </Footer.Link>
                        ...
                        <div>
                          <Footer.Title title={<FormattedMessage id="Legal" defaultMessage="Legal" />} />
                          <Footer.LinkGroup col={true}>
                            <Footer.Link href="#">
                              ''
                            </Footer.Link>
